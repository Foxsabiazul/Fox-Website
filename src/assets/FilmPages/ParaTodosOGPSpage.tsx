...
import "./VDVpage.css";
import varse from "../imgs/PTOGPSp.webp";
        ...
        <div className="PFm">
            ...
            <Header/>
             ...
             <div className="PFcont">
                ...
                <div className="PFtitulo"><p className="PFtitulo2">Para Todos Os Garotos: PS. Ainda Amo Você</p></div>
                <div className="PFdescricao"><p className="PFdescricao2">Em Para Todos Os Garotos: PS. Ainda Amo Você, Lara Jean (Lana Condor) não esperava se apaixonar por Peter Kavinsky (Noah Centineo) quando eles fingiam namorar, mas agora a relação dos dois deixou de ser artificial. Só que, ao se reconectar com uma paixão do passado, John (Jordan Fisher), tudo fica ainda mais complicado para a jovem, que precisa entender o que se passa internamente para tomar uma grande decisão.</p>
                </div>
                </div>
                </div>
