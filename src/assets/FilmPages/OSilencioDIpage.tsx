...
import "./VDVpage.css";
import varse from "../imgs/OSilencioDIp.jpg";
        ...
        <div className="PFm">
            ...
            <Header/>
             ...
             <div className="PFcont">
                ...
                <div className="PFtitulo"><p className="PFtitulo2">O Silêncio dos Inocentes</p></div>
                <div className="PFdescricao"><p className="PFdescricao2">A agente do FBI, Clarice Starling (Jodie Foster) é ordenada a encontrar um assassino que arranca a pele de suas vítimas. Para entender como ele pensa, ela procura o periogoso psicopata, Hannibal Lecter (Anthony Hopkins), encarcerado sob a acusação de canibalismo.</p>
                </div>
                </div>
                </div>
...
export default OSilencioDIpage