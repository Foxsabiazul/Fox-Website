...
import "./VDVpage.css";
import varse from "../imgs/DeVoltaPFp.webp";
        ...
        <div className="PFm">
            ...
            <Header/>
             ...
             <div className="PFcont">
                ...
                <div className="PFtitulo"><p className="PFtitulo2">De Volta para o Futuro</p></div>
                <div className="PFdescricao"><p className="PFdescricao2">Um jovem (Michael J. Fox) aciona acidentalmente uma máquina do tempo construída por um cientista (Christopher Lloyd) em um Delorean, retornando aos anos 50. Lá conhece sua mãe (Lea Thompson), antes ainda do casamento com seu pai, que fica apaixonada por ele. Tal paixão põe em risco sua própria existência, pois alteraria todo o futuro, forçando-o a servir de cupido entre seus pais.</p>
                </div>
                </div>
                </div>
